...
def read_config(config_file = 'db_config.ini', section = 'mysql'):
    """
...
def make_connection(config_file = 'db_config.ini', section = 'mysql'):
    """
...
def updateLoggedInUserId():
    global loggedInUser
    global loggedInUserId
    loggedInUserId = loggedInUser[4]

def get_current_user_role() -> str :
    global loggedInUser
    global loggedInUserRole
    loggedInUserRole = loggedInUser[3]
    return loggedInUserRole

# def setUserLoggedIn(isLoggedIn: bool):    
#     global isUserLoggedIn
#     isUserLoggedIn = isLoggedIn

# def getUserLoggedInStatus():
